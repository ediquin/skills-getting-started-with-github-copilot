...
activities = {
    ...
    "Soccer Team": {
        ...
        "max_participants": 22,
        "participants": ["alex@mergington.edu", "riley@mergington.edu", "noah@mergington.edu"]
    },
    "Swimming Club": {
        "description": "Technique improvement and lap training in the school pool",
    ...
    "Choir": {
        "description": "Vocal training and performance opportunities for concerts",
        "schedule": "Thursdays, 3:30 PM - 5:00 PM",
        "max_participants": 40,
        "participants": ["ethan@mergington.edu", "mia@mergington.edu", "harper@mergington.edu"]
    },
    "Math Club": {
